        ...
        <Row className="align-items-center">
          ...
          <Col size={12} sm={6} className="text-center text-sm-end">
            <div className="social-icon">
              ...
              <a href="https://twitter.com/us006_abhishek"><img src={navIcon2} alt="Icon" /></a>
              <a href="https://www.instagram.com/_they_all_call_me_abhi_/?utm_source=qr&igsh=MTRneXR0bmRpanh5bw%3D%3D"><img src={navIcon3} alt="Icon" /></a>
            </div>
